                        ...
                        <div class="lh-side-reservation">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <p><strong>Nhận phòng:</strong>
                                            {{ \App\Helpers\FormatHelper::FormatDate($booking->check_in) }}</p>
                                        <p>{{ $booking->check_in_time }}</p>
                                    </div>
                                    <div class="col-md-6">
                                        <p><strong>Trả phòng:</strong>
                                            {{ \App\Helpers\FormatHelper::FormatDate($booking->check_out) }}</p>
                            ...
                            <div class="lh-check-block-content mb-4">
                                ...
                                <p>{{ $booking->rooms->count() }} phòng cho
                                    {{ $booking->total_guests + $booking->children_count }} người</p>
                            ...
                            <div class="lh-check-block-content">
                                ...
                                <p><i class="fas fa-check-circle text-success me-2"></i> 8% Thuế GTGT:
                                    {{ \App\Helpers\FormatHelper::FormatPrice($booking->tax_fee) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-2">
                                                <p><strong>Số điện thoại:</strong>
                                                    {{ $booking->user->phone ?? 'Chưa cung cấp' }}</p>
                                            </div>
                                            <div class="col-md-6 mb-2">
                                                <p><strong>Quốc gia:</strong>
                                                    {{ $booking->user->country ?? 'Chưa cung cấp' }}</p>
                                            </div>
                                            <div class="col-md-6 mb-2">
                                            ...
                                            <div class="col-md-6 mb-2">
                                                <p><strong>Số CMND/CCCD:</strong>
                                                    {{ $booking->user->id_number ?? 'Chưa cung cấp' }}</p>
                                            </div>
                                            <div class="col-md-6 mb-2">
                                            ...
                                            @foreach ($booking->guests as $index => $guest)
                                                <div class="guest-info mb-4">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 mb-2">
                                                            <p><strong>Số CMND/CCCD:</strong>
                                                                {{ $guest->id_number ?? 'Chưa cung cấp' }}</p>
                                                        </div>
                                                        <div class="col-md-6 mb-2">
                                                            <p><strong>Ngày sinh:</strong>
                                                        ...
                                                        <div class="col-md-6 mb-2">
                                                            <p><strong>Số điện thoại:</strong>
                                                                {{ $guest->phone ?? 'Chưa cung cấp' }}</p>
                                                        </div>
                                                        <div class="col-md-6 mb-2">
                                                            <p><strong>Email:</strong>
                                                                {{ $guest->email ?? 'Chưa cung cấp' }}</p>
                                                        </div>
                                                        <div class="col-md-6 mb-2">
                                                            <p><strong>Quan hệ với người đặt:</strong>
                                                                {{ $guest->relationship ?? 'Chưa cung cấp' }}</p>
                                                        </div>
                                                        <div class="col-md-6 mb-2">
                                                            <p><strong>Ảnh CMND/CCCD:</strong>
                                                                @if ($guest->id_photo)
                                ...
                                <div class="lh-checkout-wrap mb-4">
                                    ...
                                    <div class="lh-check-block-content">
                                        ...
                                        @elseif ($booking->status == 'paid')
                                            <p class="text-info"><i class="fas fa-check-circle me-2"></i> Đặt phòng đã
                                                được thanh toán, không thể hủy.</p>
                                        ...
                                        @else
                                            <p class="text-muted"><i class="fas fa-info-circle me-2"></i> Không thể hủy
                                                đơn đặt phòng ở trạng thái hiện tại ({{ $booking->status }}).</p>
                                        @endif
