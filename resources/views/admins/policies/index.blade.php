                ...
                <div class="lh-card" id="bookingtbl">
                    <div class="lh-card-header">
                        ...
                        <div class="header-tools">
                            ...
                            <button class="btn btn-primary ms-2" onclick="window.location.href='{{ route('admin.policies.create') }}'">
                                Tạo mới
                            </button>
                        </div>
                    </div>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a class="dropdown-item" href="{{ route('admin.policies.edit', $item->id) }}">
                                                                <i class="ri-edit-line"></i> Sửa
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <form action="{{ route('admin.policies.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Bạn có muốn xóa mềm không?');">
                                                                @csrf
                                                                @method('DELETE')
