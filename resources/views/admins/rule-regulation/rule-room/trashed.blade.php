    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <tr>
                ...
                <td>
                    <form action="{{ route('admin.rule-regulations.restore_room', $item->id) }}" method="POST" style="display:inline;">
                        @csrf
                        @method('PATCH')
                        <button type="submit" class="btn btn-success">Khôi phục</button>
                    </form>
                    <form action="{{ route('admin.rule-regulations.forceDelete_room', $item->id) }}" method="POST" style="display:inline;">
                        @csrf
                        @method('DELETE')
            ...
            @endforeach
                                ...
                                <a href="{{ route('admin.rule-regulations.index') }}" class="btn btn-primary">Quay lại danh sách</a>
                            </div>
                        </div>
                    </div>
                </div>
