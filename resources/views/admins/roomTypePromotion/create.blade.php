...
@section('content')
    <div class="lh-main-content">
        <div class="container-fluid">
            <h2>Thêm mối quan hệ giữa Loại phòng và Khuyến mãi</h2>
            <form action="{{ route('admin.room_types_promotion.store') }}" method="POST">
                @csrf
                ...
                <button type="submit" class="btn btn-success mt-3">Thêm mối quan hệ</button>
