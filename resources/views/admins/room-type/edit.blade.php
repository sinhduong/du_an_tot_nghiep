            ...
            <div class="col-xxl-12 col-xl-8 col-md-12">
                <div class="lh-card" id="bookingtbl">
                    ...
                    <div class="lh-card-content card-booking">
                        <form action="{{ route('admin.room_types.update', $room_types->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                                            ...
                                            <li><strong>Trạng thái *: </strong>
                                                <div class="form-group">
                                                    <select name="is_active" class="form-control">
                                                        <option value="1" {{ old('is_active', $room_types->is_active) == 1 ? 'selected' : '' }}>Hoạt động</option>
                                                        <option value="0" {{ old('is_active', $room_types->is_active) == 0 ? 'selected' : '' }}>Không hoạt động</option>
                                                    </select>
                                                    @error('is_active')
                                                        <p class="text-danger">{{ $message }}</p>
                                                    @enderror
